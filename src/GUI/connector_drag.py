# -*- coding: utf-8 -*-
"""
Created on Sun May 13 13:46:28 2018
...
class Drag_and_drop_connector():
    
    
    def add_dragable(self, widget, original_x, original_y, connector, con_type):
    ...
    def on_drop(self, event):
        ...
        self.connector.connector_dragged(self.con_type, self.x, self.y)