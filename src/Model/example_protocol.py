...
f2 = Field.Field(1)
f2.set_field_info('Number of wins', 'wins', 'Is the number of wins', 'Integer', 'Integer', '0xff', '?', 'True')

f3 = Field.Field(1)
f3.set_field_info('Number of loses', 'loses', 'Is the number of loses', 'Integer', 'Integer', '0xff', '?', 'True')
...
protocol.get_protocol_structure(sf)
