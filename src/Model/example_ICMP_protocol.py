...
#    f1.set_ref_list(ref_list)
    ...
    source_quench_field.set_field_info('Code_source', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    source_quench_field_3.set_field_info('Unused_source', 'Unused', 'Unused', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    source_quench_field_4 = Field.Field(4)
    source_quench_field_4.set_field_info('IP_header_source', 'IP_header', 'IP_header', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    redirect_field.set_field_info('Code_redirect', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    redirect_field_3.set_field_info('IP_addr_redirect', 'IP_addr', 'IP_addr', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    te_field.set_field_info('Code_te', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    te_field_3.set_field_info('Unused_te', 'Unused', 'Unused', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    te_field_4 = Field.Field(4)
    te_field_4.set_field_info('IP_header_te', 'IP_header', 'IP_header', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    ts_field.set_field_info('Code_ts', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    ts_field_3.set_field_info('Identifier_ts', 'Identifier', 'Identifier', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    ts_field_4 = Field.Field(2)
    ts_field_4.set_field_info('Seq_number_ts', 'Seq_number', 'Seq_number', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    ...
    tsr_field.set_field_info('Code_tsr_tsr', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    tsr_field_3.set_field_info('Identifier_tsr', 'Identifier', 'Identifier', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    tsr_field_4 = Field.Field(2)
    tsr_field_4.set_field_info('Seq_number_tsr', 'Seq_number', 'Seq_number', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    tsr_field_5 = Field.Field(4)
    tsr_field_5.set_field_info('Original_timestamp_tsr', 'Original_timestamp', 'Original_timestamp', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    tsr_field_6 = Field.Field(4)
    tsr_field_6.set_field_info('Recieve_timestamp_tsr', 'Recieve_timestamp', 'Recieve_timestamp', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    tsr_field_7 = Field.Field(4)
    tsr_field_7.set_field_info('Transmit_timestamp_tsr', 'Transmit_timestamp', 'Transmit_timestamp', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    adr_mask_field.set_field_info('Code_addrmask_adr_mask', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    adr_mask_field_3.set_field_info('Identifier_adr_mask', 'Identifier', 'Identifier', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    adr_mask_field_4 = Field.Field(2)
    adr_mask_field_4.set_field_info('Seq_number_adr_mask', 'Seq_number', 'Seq_number', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    adr_mask_field_5 = Field.Field(4)
    adr_mask_field_5.set_field_info('Address_mask_adr_mask', 'Address_mask', 'Address_mask', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    adr_mask_r_field.set_field_info('Code_addrmask_r', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    adr_mask_r_field_3.set_field_info('Identifier_addrmask_r', 'Identifier', 'Identifier', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    adr_mask_r_field_4 = Field.Field(2)
    adr_mask_r_field_4.set_field_info('Seq_number_addrmask_r', 'Seq_number', 'Seq_number', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    adr_mask_r_field_5 = Field.Field(4)
    adr_mask_r_field_5.set_field_info('Address_mask_addrmask_r', 'Address_mask', 'Address_mask', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
    ...
    du_field.set_field_info('Code_du', 'Code', 'Code', 'ftypes.UINT8', 'base.HEX', '0xf', 'nil', 'True')
    ...
    du_field_3.set_field_info('Unused_du', 'Unused', 'Unused', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    du_field_4 = Field.Field(2)
    du_field_4.set_field_info('Next_hop_MTU_du', 'Next_hop_MTU', 'Next_hop_MTU', 'ftypes.UINT16', 'base.HEX', '0xff', 'nil', 'True')
    du_field_5 = Field.Field(4)
    du_field_5.set_field_info('ip_header_du', 'ip_header', 'ip_header', 'ftypes.UINT32', 'base.HEX', '0xffff', 'nil', 'True')
